...
\### Content ID: \`0d2d7f7b-e177-44ab-a7ed-0fc3664728e2\`
...
\\- I’m not quite sure why each browser \_needs\_ its own JS runtime, but there are \[quite\\\](https://en.wikipedia.org/wiki/Comparison\\\_of\\\_JavaScript\\\_engines">quite) a few implementations of web standards\](%5Bhttps://en.wikipedia.org/wiki/Comparison\_of\_JavaScript\_engines) so it makes sense because of the complexity of \[browsers\](https://web.dev/howbrowserswork/).
...
\\- basic event loop from \[mdn\](%5Bhttps://developer.mozilla.org/en-US/docs/Web/JavaScript/EventLoop#event\_loop)\\\](\[https://developer.mozilla.org/en-US/docs/Web/JavaScript/EventLoop#event\\\_loop">mdn\](https://developer.mozilla.org/en-US/docs/Web/JavaScript/EventLoop#event\_loop%22%3Emdn))
...
\\- The event loop is what keeps track of calls to the stack, message queue, and memory. It’s interesting because \[heaps\](%5Bhttps://github.com/qweliant/GO-Practice/blob/master/algorithms/24\_binary\_heap\_sort.go),\\\](\[https://github.com/qweliant/GO-Practice/blob/master/algorithms/24\\\_binary\\\_heap\\\_sort.go">heaps\](https://github.com/qweliant/GO-Practice/blob/master/algorithms/24\_binary\_heap\_sort.go%22%3Eheaps),) \[queues\](%5Bhttps://github.com/qweliant/GO-Practice/blob/master/algorithms/18\_queue.go),\\\](\[https://github.com/qweliant/GO-Practice/blob/master/algorithms/18\\\_queue.go">queues\](https://github.com/qweliant/GO-Practice/blob/master/algorithms/18\_queue.go%22%3Equeues),) and \[stacks\](%5Bhttps://github.com/qweliant/GO-Practice/blob/master/algorithms/19\_stack.go),\\\](\[https://github.com/qweliant/GO-Practice/blob/master/algorithms/19\\\_stack.go">stacks\](https://github.com/qweliant/GO-Practice/blob/master/algorithms/19\_stack.go%22%3Estacks),) are the fundamentals of this architecture.
...
\- \*\*Property ID\*\*: \`63535e81-2300-473f-bc15-f55b50eb7e60\`
 \- Object ID: \`b291832b-a484-4ee6-8744-91e0c6577e74\`
 \- Boolean Value: false
...
\-\-\-
Exported on 2025-01-23T00:40:36.660Z