...
Github link: [fineshyt](https://github.com/qweliant/fineshyt)<sup><a href="#fn-1">1</a></sup>
...
2. It was expensive! The amount of compute LLaVa takes to run the classification task could spike total RAM usage to 15 gigs. It's literally easier to run bg3
...
<ol>
  <li id="fn-1">GitHub - qweliant/fineshyt — GitHub. <a href="https://github.com/qweliant/fineshyt">https://github.com/qweliant/fineshyt</a></li>
  <li id="fn-2">Deploying Transformer Models. <a href="https://qwelian.com/posts/Deploying_Transformer_Models">https://qwelian.com/posts/Deploying_Transformer_Models</a></li>
</ol>
