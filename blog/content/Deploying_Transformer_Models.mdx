...
- [Install Docker](https://docs.docker.com/get-docker/)<sup><a href="#fn-4">4</a></sup>

- [Install Docker Compose](https://docs.docker.com/compose/install/)<sup><a href="#fn-5">5</a></sup>

- [Install Google Cloud SDK](https://cloud.google.com/sdk/install)<sup><a href="#fn-6">6</a></sup>
...
5. Allow unauthenticated requests (if you want a publicly consumable API)
6. Click next then advanced settings.
...
<ol>
  <li id="fn-1">Transformers · Hugging Face. <a href="https://huggingface.co/docs/transformers/index">https://huggingface.co/docs/transformers/index</a></li>
  <li id="fn-2">GitHub - huggingface/transformers: 🤗 Transformers: the model-definition framework for state-of-the-art machine learning models in text, vision, audio, and multimodal models, for both inference and training. — GitHub. <a href="https://github.com/huggingface/transformers">https://github.com/huggingface/transformers</a></li>
  <li id="fn-3">FastAPI - FastAPI. <a href="https://fastapi.tiangolo.com/">https://fastapi.tiangolo.com/</a></li>
  <li id="fn-4">Get Docker — Docker Documentation. <a href="https://docs.docker.com/get-docker/">https://docs.docker.com/get-docker/</a></li>
  <li id="fn-5">Overview of installing Docker Compose — Docker Documentation. <a href="https://docs.docker.com/compose/install/">https://docs.docker.com/compose/install/</a></li>
  <li id="fn-6">Quickstart: Install the Google Cloud CLI  |  Google Cloud SDK  |  Google Cloud Documentation — Google Cloud Documentation. <a href="https://cloud.google.com/sdk/install">https://cloud.google.com/sdk/install</a></li>
</ol>
